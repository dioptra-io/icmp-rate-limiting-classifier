...
if __name__ == "__main__":
    nodes4 = ["ple41.planet-lab.eu", "cse-yellow.cse.chalmers.se", "ple1.cesnet.cz", "planetlab1.cs.vu.nl"]
    ...
    unresponsives = None
    for node in nodes6:
        result_individual_file = "resources/results/internet2/individual/" + node + "_individual_results6"
